  ...
  function adicionarPaginas(indice,itens,ordem,prefixo){
   ...
   paginas.forEach((estado)=>{
    ...
    const riscar=(conteudo,estaConcluida)=>estaConcluida
     ...
     : conteudo;
    const textoInstrucao=(conteudo)=>conteudo;
...
.progresso-ascii { display: block; width: 100%; box-sizing: border-box; margin: 1em 0; font-family: monospace; white-space: nowrap; }
